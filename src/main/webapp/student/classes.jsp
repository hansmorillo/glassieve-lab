...
<%
    ...
    PreparedStatement ps = conn.prepareStatement(
            "SELECT c.id, c.code, c.name, c.description " +
                    "FROM classes c JOIN enrollments e ON c.id = e.class_id " +
...
%>
<a class="class-card"
   href="${pageContext.request.contextPath}/student/assignments.jsp?classId=<%= rs.getInt("id") %>">
...
<a class="back" href="${pageContext.request.contextPath}/student/dashboard.jsp">
    ← Back to dashboard
</a>
</body>
</html>