...
<div class="card-grid">
  <a class="card" href="${pageContext.request.contextPath}/student/classes.jsp">
    <div class="card-icon">📚</div>
    <div class="card-title">My Classes</div>
    <div class="card-desc">View enrolled classes and submit assignments.</div>
  </a>
  <a class="card" href="${pageContext.request.contextPath}/student/submissions.jsp">
    <div class="card-icon">📄</div>
    <div class="card-title">All Submissions</div>
    <div class="card-desc">Review all your past submissions and grades.</div>
  </a>
</div>
</body>
</html>